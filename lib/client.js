...
var UsagePanel = ({ overview, recent, title = "Usage" }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontFamily: "inherit", color: C.textPrimary, fontSize: "0.8rem" }, children: [
...
var UsageSection = (props) => {
  ...
  const overview = su ? { totals: su.totals, previous: null, series: [], byModel: [], byDimension: [] } : void 0;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(UsagePanel, { overview, recent, title: "LLM Usage (this session)" });
};
function apply(ctx) {
  if (ctx?.slots?.inject) {
...
var index_default = { inject, apply, activate, UsagePanel, UsageSection };
